    ...
    <div class="wrapper">
        ...
        <?php
             if(isset($_GET['q']))
             {
                ...
                $con=new MySQL();
                $id=$_GET['q'];
                $rs=mysql_query("select * from about_us_category where id=".$id);
                $r=mysql_fetch_array($rs);
                $con->CloseConnection();
             }
        ?>
        <form  style="margin-top:20px;" action="update-about-us-category2.php" method="post" class="form" id="validate">
        	...
        	<fieldset>
                <div class="widget" style="margin-top: 20px;">
                    ...
                    <div class="formRow">
                        ...
                        <div class="formRight">
                            <input type="text" value="<?php echo $r['name']; ?>" id="txtCategoryName" name="txtCategoryName" class="validate[required]" />
