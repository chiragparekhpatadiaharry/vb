    ...
    <div class="wrapper">
        ...
        <?php
             if(isset($_GET['q']))
             {
                ...
                $con=new MySQL();
                $id=$_GET['q'];
                $rs=mysql_query("select * from album_photo_gallery where id=".$id);
                $r=mysql_fetch_array($rs);
                $con->CloseConnection();
             }
        ?>
        <form  style="margin-top:20px;" action="update-photo-album2.php" method="post" class="form" id="validate">
            <input type="hidden" name="hidId" value="<?php echo $r['id']; ?>" />
        	<fieldset>
                <div class="widget" style="margin-top: 20px;">
                    <div class="title">
                        <img class="titleIcon" alt="" src="images/icons/dark/pencil.png" />
                        <h6>Update Photo Album</h6>
                    </div>
                    <div class="formRow">
                        <label>Album Name:&nbsp;<span class="req">*</span></label>
                        <div class="formRight">
                            <input type="text" value="<?php echo $r['name']; ?>" id="txtPhotoAlbumName" name="txtPhotoAlbumName" class="validate[required]" />
